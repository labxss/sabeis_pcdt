...
Projeção trimestral de dispensações do medicamento 
relativo ao Protocolo Clínico e Diretrizes Terapêuticas (PCDT).

### Interpretação

- O eixo vertical ($y$) corresponde ao número de dispensações do medicamento.
...
- Projetar o número de dispensações em até cinco anos.
...
l=dim(subset(tf_pcdt_medicamento_trimestre, sg_procedimento == 'ADAL40' & co_pcdt == 10))[1] # numero de afericoes
    ...
    plot(
      forecast(auto.arima(subset(tf_pcdt_medicamento_trimestre, sg_procedimento == 'ADAL40' & co_pcdt == 10)$qt_dispensacao/1000, allowmean = TRUE), h = 20),
      xlab = "",
