...
Proporção de óbitos de Protocolo Clínico e Diretrizes Terapêuticas - PCDT 
...
- Se igual a 100, todos os óbitos são de homens ou mulheres de uma dada faixa-etária.

### Usos

- Analisar variações na distribuição de óbitos por sexo e faixa-etária.
...
$n_{SF}$ é o número de óbitos do sexo e da faixa etária 
e $T$ é o total de óbitos do PCDT, obtido por $T=\sum{n_{SF}}$.
...
pyramid(subset(tf_pcdt_paciente, co_pcdt == 16)[,c(4,5,6)], Llab="Masculino",Rlab="Feminino", Lcol="navy", Ldens=5, Rcol="red",
